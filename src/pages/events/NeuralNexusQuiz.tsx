...
import { Brain, ArrowLeft, ArrowRight, Clock, Trophy, Users, CheckCircle, AlertCircle, Mail, Phone } from "lucide-react";
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className={`inline-flex items-center gap-3 px-4 py-2 rounded-full ${styles.accentBg} text-foreground text-sm mb-6`}>
              <Brain className="w-4 h-4" /><span>Universe 06</span>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex justify-between mt-12">
              <Link to="/events/hardware-hack-arena"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Hardware Hack Arena</Button></Link>
              <div />
            </div>
          </div>
        </div>
...
export default NeuralNexusQuiz;